...
if __name__=="__main__":
    ...
    parser.add_argument("--dec_model", nargs="?", type=str, default= "hivt",choices=["autobots", "hivt",     "ViTag","GRU","RNN",'Baseline','Vanilla', "LSTM", "NMT", "UNet", "Transformer","SingleLayerViTag","VisionPosition"], help="input img size")
