...
class Calculate():
    ...
    def train(self, config):
        ...
        interl_gps, nearst_gps, imu19, bbx4 = next(iter(self.train_dataloader))
        ...
        for epoch in range(args.epochs):
            ...
            valid_iou_loss = []
            with torch.no_grad():
                for idx, (interl_gps, nearst_gps, imu, bbx) in enumerate(self.train_dataloader): # interl_gps, nearst_gps, imu19, bbx4
