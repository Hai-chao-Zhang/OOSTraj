...
from model.baseline import Baseline, Vanilla_Baseline, Kalman_Baseline
...
class Calculate():
    def __init__(self, model, device="cuda:0"):
        ...
        self.ckpt_saving_path = os.path.join(f"checkpoints", f"{args.model}_{args.dec_model}_{pos}")
...
if __name__=="__main__":
    ...
    parser.add_argument("--model", nargs="?", type=str, default= "Transformer",choices=[ "ViTag", 'Baseline','Vanilla', "Kalman", "LSTM", "NMT", "UNet", "Transformer","SingleLayerViTag","VisionPosition"], help="input img size")
    parser.add_argument("--dec_model", nargs="?", type=str, default= "Transformer",choices=["autobots", "hivt",     "ViTag","GRU","RNN",'Baseline','Vanilla', "LSTM", "NMT", "UNet", "Transformer","SingleLayerViTag","VisionPosition"], help="input img size")
    ...
    if args.model == 'VisionPosition':
        ...
        model = Vanilla_Baseline(C)
    elif args.model == 'Kalman':
        model = Kalman_Baseline(C)
    else:
