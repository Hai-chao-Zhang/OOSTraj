...
class Dataset_ViFi(Dataset):
    def __init__(self, C, flag='train', shuffle_unsup = False):
        ...
        self.C = C
        with open(os.path.join( "/home/haichao/code/gps/gpspred/vifi_dataset_gps/vifi_data.pkl"), 'rb') as f:
            data = pickle.load(f)
...
def load_data(C, datasetname=Dataset_ViFi, shuffle_unsup=False):
    ...
    valid_dataloader = DataLoader(dataset=valid_dataset, batch_size=500, shuffle=False)
