...
seq_in_BBX5, seq_in_FTM2, seq_in_IMU19, seq_out_BBX5 = pickle.load(open("/home/haichao/code/toyota/trajpred/data/indoor.pkl", 'rb'))
transform = transforms.Compose([transforms.ToTensor(), ])  # transforms.Normalize((0.5), (0.5))
# def norm(a):
#     channel = a.shape[0]
#     return transforms.Normalize((0.5,)*channel, (0.5,)*channel)(a).permute(1,2,0)
# seq_in_BBX5 = norm(transform(seq_in_BBX5)/2048.)
# seq_in_FTM2 = norm(transform(seq_in_FTM2)/2048.)#.permute(1,2,0))
# seq_in_IMU19 = norm(transform(seq_in_IMU19)/64.)#.permute(1,2,0))
# seq_out_BBX5 = norm(transform(seq_out_BBX5)/2048.)#.permute(1,2,0))


for desired_source in ['vifi']:
    for data_class in ['train', 'val', 'test']:

        if flag=='test':
            seq_in_BBX5, seq_in_FTM2, seq_in_IMU19, seq_out_BBX5 = seq_in_BBX5[:3000], seq_in_FTM2[:3000], seq_in_IMU19[:3000], seq_out_BBX5[:3000]
        elif flag=='train':
            seq_in_BBX5, seq_in_FTM2, seq_in_IMU19, seq_out_BBX5 = seq_in_BBX5[5000:], seq_in_FTM2[5000:], seq_in_IMU19[5000:], seq_out_BBX5[3000:]
        elif flag=='test':
            seq_in_BBX5, seq_in_FTM2, seq_in_IMU19, seq_out_BBX5 = seq_in_BBX5[3000:5000], seq_in_FTM2[3000:5000], seq_in_IMU19[3000:5000], seq_out_BBX5[3000:5000]
        else:
            raise ValueError("flag")
        length = seq_in_BBX5.shape[0]
        ...
        data = pd.DataFrame([ seq_in_BBX5, seq_in_FTM2, seq_in_IMU19, seq_out_BBX5])
